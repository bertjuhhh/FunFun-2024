...
LEDKAST_1 = Ledkast(pin=0, ledCount=300, name="LEDKAST_1") 
LEDKAST_1b = Ledkast(pin=1, ledCount=300, name="LEDKAST_1b") 
LEDKAST_2 = Ledkast(pin=2, ledCount=300, name="LEDKAST_2") 
LEDKAST_2b = Ledkast(pin=3, ledCount=300, name="LEDKAST_2b") 
LEDKAST_3 = Ledkast(pin=12, ledCount=300, name="LEDKAST_3") 
LEDKAST_3b = Ledkast(pin=13, ledCount=300, name="LEDKAST_3b") 
LEDKAST_4 = Ledkast(pin=14, ledCount=300, name="LEDKAST_4") 
LEDKAST_4b = Ledkast(pin=15, ledCount=300, name="LEDKAST_4b")
